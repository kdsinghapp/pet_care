class GetAllUsersPostModel {
  List<GetAllUsersPostResult>? result;
  String? message;
  String? status;

  GetAllUsersPostModel({this.result, this.message, this.status});

  GetAllUsersPostModel.fromJson(Map<String, dynamic> json) {
    if (json['result'] != null) {
      result = <GetAllUsersPostResult>[];
      json['result'].forEach((v) {
        result!.add(GetAllUsersPostResult.fromJson(v));
      });
    }
...
class GetAllUsersPostResult {
  ...
  GetAllUsersPostResult.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
